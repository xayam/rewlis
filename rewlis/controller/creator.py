...
for book in folder_of_books:
    ...
    if not os.path.exists(f"{data}/{book}/{config.RUS_SYNC}"):
        ...
        with open(f"{data}/{book}/{config.RUS_SYNC}", mode="r") as fsync:
    ...
    if not os.path.exists(f"{data}/{book}/{config.ENG_SYNC}"):
        ...
        with open(f"{data}/{book}/{config.ENG_SYNC}", mode="r") as fsync:
    ...
    with open(f"{data}/{book}/{config.MICRO_JSON}", mode="r") as f:
        m = json.load(f)
